...
Many studies, internationaly or nationaly, demonstrate that the academic world suffers from discriminations, harrasment and unwell-being issues. It can be difficult to clearly acknowledge this and take actions against it, and it is of course even harder when we are in vulnerable positions and/or suffer from such issues directly. Trying to follow a researcher approach and notably using scientific references whenver possible, this talk will gather as many evidence as possible on those subject, and try to discover through several hypothesis what, if any, are the root causes for those issues in the academic world. We will highlight that the causes are not only external and outside of our controls: equipped with a good understanding of the issues, it is possible to act against those issues, as researchers and within our labs. We will focus on concrete possible actions that can help both witnesses and targets of dangerous situations happening right now to manage the emergency, but also on actions and policies that can help build an environnment and a culture where such situations do not happen anymore, presenting concrete actions that can be taken, at all levels of the hierarchy: as a PhD student, as a permanent researcher, as an advisor, as a head of lab, and as a hiring committee member.
...
They also come from a very young age, as the exact same toy can be branded as a princess thing for girls and a science thing for boys.
...
16 studies wordwide, 24% of depression among phd students  [@satinsky2021systematic]
...
Further, even with equal CVs, the evaluation is biased: 
 ...
 - URM faculty received 7% more negative votes and were 44% less likely to receive unanimous votes from P&T committees  [@masters2024underrepresented]
  - Career breaks are discriminated against in CVs. [@kristal2023reducing]
...
The french 2015 reform, where a share of at least 40% women was imposed on hiring committee, in fact had negative impact on STEM fields, where women were judged more harshly.  [@deschamps2024gender]
...
**male evaluators become less favorable toward female candidates as soon as a female evaluator joins the committee** [@bagues2017does]
...
The evidence is overwhelming, sexual-harassment (which incllude sexual coercion, unwanted sexual attention, but also gender harassment, any putdown or hostility based on gender)
is everywhere.
...
Since their arrivals in french higher education, the share of students target of a sexual assault or rape, often reiterated, is **24% of women,  9% of men and 33% of transgenders/non binaries/queers** [@vss-alcool-mildeca]
...
And we have strong power imbalances in academia, so much so that: "the **academic** workplace has the **second highest rate of sexual harassment at 58 percent**
...
![](presentation/slide-summary-power.png)
...
Institutions do not do enough: do not adress the most common form of harassment (gender-harassment), provide report procedure opaque  [@he2024association] and inefficient, leading to a feeling of betrayal [@bergeron2025can], and often focused on protecting the image of the institution  [@faniko2021inegalites]. Universities focus on following the law meant to reduce discrimination, which had little impact on harassment. [@benya2018sexual] Most targets of harassment don't report issues. [@lipinsky2022gender]

Actually, scratch that, a fourth point of view:
 * ours. We do the research, we are part of this toxic culture, and we have power over it. We can be the change. 
...
required to prevent and effectively address all three forms of sexual harassment."   [@benya2018sexual]
...
42% of PhD students think it’s 
normal to suffer mentally.  [@21]
...
![](biblio-pics/brook-active-bystander.png)
...
See e.g. the study at Berkley:
![](biblio-pics/culpepper2023rubrics-fig20a.png)


But, between 2017 and 2022, the Astro3d center reached parity, from 38% to 50%. [@kewley2023achievement]


Things to try!

 - have a women for president, but a men for the administrative part (sending out invitations, doing the planing, etc) (to fight against the male president backlash  [@deschamps2024gender])
 - have clear goals and general agreement on the diversity issue and discriminations. [@goulden2019searching]
 - when possible, shape the job description to target diversity [@goulden2019searching]
 - ask for CVs without dates, only experience lengths  [@kristal2023reducing] [@biteam]
 - agree before hands on criterion and use rubrics (but be careful, a rubric can in itself discriminate, if based on something unequally easy to do)  [@culpepper2023rubrics] [@biteam]
